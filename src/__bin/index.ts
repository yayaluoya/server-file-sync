...
(async () => {
    ...
    switch (true) {
        ...
        case Boolean(opts.help):
            ...
            console.log(chalk.green('   -s --select ') + chalk.gray('手动选择keys，如果已经指定了keys的话将会作为选择的默认值'));
            ...
            console.log(chalk.gray('    如果有什么问题请在 https://github.com/yayaluoya/server-file-sync/issues 提出'));
            break;
